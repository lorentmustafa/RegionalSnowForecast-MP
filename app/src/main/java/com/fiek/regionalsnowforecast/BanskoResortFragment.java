...
public class BanskoResortFragment extends Fragment {
    ...
    private final String locationId = "54883463";
    private final String appId = "fcf3f15c";
    private final String appKey = "c3e243251bb3b7cfc9d03c007dd1a96f";
