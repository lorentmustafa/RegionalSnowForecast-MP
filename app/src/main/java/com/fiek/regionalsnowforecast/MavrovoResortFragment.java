...
public class MavrovoResortFragment extends Fragment {
    ...
    private final String locationId = "54886459";
    private final String appId = "50e61f47";
    private final String appKey = "fe9876b2aadf511c254f00c3cdfd0a96";
